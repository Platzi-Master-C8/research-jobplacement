...
class Company(Base):
    ...
    avg_reputation = Column(Float(2), nullable=True, default=0)
    total_ratings = Column(Integer, nullable=True, default=0)
    death_line = Column(DateTime, nullable=True)
    ceo_score = Column(Float(2), nullable=True, default=0)
    website = Column(Text, nullable=True)
    culture_score = Column(Float(2), nullable=True, default=0)
    work_life_balance = Column(Float(2), nullable=True, default=0)
    stress_level = Column(Float(2), nullable=True, default=0)
    carrer_opportunities = Column(Float(2), nullable=True, default=0)
...
class UserReview(Base):
    ...
    review_title = Column(String(150), nullable=False)
    ...
    review_score = Column(Float(2), nullable=False, default=0)
    review_date = Column(DateTime, nullable=False)
    utility_counter = Column(Integer, nullable=True, default=1)
    score_work_environment = Column(Float(2), nullable=True, default=0)
    score_career_development = Column(Float(2), nullable=True, default=0)
    score_culture = Column(Float(2), nullable=True, default=0)
    score_perks = Column(Float(2), nullable=True, default=0)
    score_stress_level = Column(Float(2), nullable=True, default=0)
    score_work_life_balance = Column(Float(2), nullable=True, default=0)
    diversity_score = Column(Float(2), nullable=True, default=0)
    review_link = Column(Float(2), nullable=True)
